...
impl Default for SVMTransactionExecutionCost {
    fn default() -> Self {
        SVMTransactionExecutionCost {
            ...
            // Ryzen 5 7500F (Zen 4) at the x86-64-v2 shipping profile, mcl FFI
            ...
            alt_bn128_g1_msm_per_point_cost: 930,
            alt_bn128_pairing_check_base_cost: 6_653,
            alt_bn128_pairing_check_per_pair_cost: 2_685,
            alt_bn128_g2_subgroup_check_cost: 3_337,
            ...
            alt_bn128_fr_lincomb_per_term_cost: 3,
            alt_bn128_fr_batch_invert_base_cost: 100,
            alt_bn128_fr_batch_invert_per_term_cost: 5,
        }
    }
}
