...
mod tests {
    ...
    #[test]
    #[ignore = "manual A/B: cargo test --release -p helius-bn254 --lib -- --ignored variants_bench --nocapture"]
    ...
    #[test]
    #[ignore = "manual profiling: cargo test --release -p helius-bn254 --lib -- --ignored profile_split --nocapture"]
    ...
    #[test]
    #[ignore = "manual A/B: cargo test --release -p helius-bn254 --lib -- --ignored kaliski_variants --nocapture"]
