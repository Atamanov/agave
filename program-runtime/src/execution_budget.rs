...
impl Default for SVMTransactionExecutionCost {
    fn default() -> Self {
        SVMTransactionExecutionCost {
            ...
            // Ryzen 5 7500F (Zen 4) at the x86-64-v2 shipping profile, helios-bn254 (portable tier at this profile)
            ...
            alt_bn128_g1_msm_per_point_cost: 1_126,
            alt_bn128_pairing_check_base_cost: 11_430,
            alt_bn128_pairing_check_per_pair_cost: 1_567,
            alt_bn128_g2_subgroup_check_cost: 3_503,
