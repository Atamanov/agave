...
use helius_bn254::pairing::{final_exponentiation, miller_loop};
use helius_bn254::{Fp, Fr, G1Affine, G1Projective, G2Affine, G2Projective, pairing};
...
fn run_loop(op: &str) -> ! {
    ...
    let mut ml = helius_bn254::Fp12::ONE;
    let mut e = helius_bn254::Fp12::ONE;
