...
use helius_bn254::pairing::{final_exponentiation, miller_loop, multi_pairing};
use helius_bn254::{Fp12, Fr, G1Projective, G2Projective, pairing_product_is_one};
...
fn main() {
    let g1 = G1Projective::generator()
        ...
        .to_affine();
    let g2 = G2Projective::from(helius_bn254::G2Affine::test_generator())
        .mul(Fr::from_u64(0xdead_beef_cafe))
        .to_affine();

    let g1b = helius_bn254::G1Bytes::from_affine(&g1);
    let g2b = helius_bn254::G2Bytes::from_affine(&g2);
    let pair = helius_bn254::PairBytes { g1: g1b, g2: g2b };
    let pairs = [pair];
