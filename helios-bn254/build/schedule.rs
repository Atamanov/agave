...
/// Register roles for `helios_mont4_mul_x86`. All fifteen usable GPRs are
...
/// Register roles for `helios_mont4_sqr_x86`.
...
/// `helios_mont4_mul_x86`: fully unrolled CIOS Montgomery multiplication.
///
...
/// `helios_mont4_sqr_x86`: dedicated Montgomery squaring.
///
...
/// Register roles for `helios_sos_x86`.
...
/// Register roles for `helios_sosd2_small_x86`.
...
/// `helios_sosd2_small_x86`: dedicated dual-lane sum of products, fixed
...
/// which is the cross-lane ILP that two serial `helios_sos_x86` calls
...
/// Register roles for `helios_fp6_mul_x86`.
...
/// `helios_fp6_mul_x86`: one whole Fp6 = Fp2[v]/(v^3 - xi) product,
...
/// Register roles for `helios_fp12_034_x86`.
...
/// `helios_fp12_034_x86`: the whole sparse Fp12 product of the Miller loop,
...
/// Register roles for `helios_fp12_sqr_x86`.
...
/// `helios_fp12_sqr_x86`: the whole Fp12 square in mcl's lazy double-width
...
/// Register roles for `helios_fp12_mul_x86` (the fp12_sqr roles verbatim:
...
/// `helios_fp12_mul_x86`: the whole Fp12 product in mcl's lazy double-width
...
/// Register roles for `helios_cyc_sqr_x86` (walk bodies shared with
...
/// `helios_cyc_sqr_x86`: the Granger-Scott cyclotomic square in mcl's lazy
...
/// `helios_sos_x86`: rolled sum-of-products Montgomery reduction
...
/// Register roles for `helios_sosd6_x86`.
...
/// `helios_sosd6_x86`: dedicated dual-lane sum of products, fixed T = 6 per
...
/// the composed route pays it as two serial `helios_sos_x86` calls whose
...
/// a 12-pointer table (the `helios_sos_x86` shape) and this staged block.
