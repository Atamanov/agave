...
fn kernelgen_constants_match_production_constants() {
    assert_eq!(BN254_P, helios_bn254::consts::P);
    assert_eq!(BN254_P_INV, helios_bn254::consts::P_INV);
    assert_eq!(BN254_MU, helios_bn254::consts::P_MU_310);
}
...
fn interpreted_schedules_match_portable_oracle() {
    use helios_bn254::Fp;
    use helios_bn254::consts::{P, P_INV};
