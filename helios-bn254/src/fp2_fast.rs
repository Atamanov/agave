...
#[cfg(not(any(
    ...
    all(helios_mont4_x86_64_adx, not(feature = "force-portable"))
)))]
...
#[cfg(any(test, all(helios_x86_intel, not(feature = "force-portable"))))]
#[cfg_attr(target_arch = "x86_64", inline(never))]
#[cfg_attr(not(target_arch = "x86_64"), inline(always))]
...
#[cfg(any(test, all(helios_mont4_x86_64_adx, not(feature = "force-portable"))))]
#[cfg_attr(target_arch = "x86_64", inline(never))]
#[cfg_attr(not(target_arch = "x86_64"), inline(always))]
