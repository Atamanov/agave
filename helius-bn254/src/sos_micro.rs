...
//! `cargo +1.97.1 test --release -p helius-bn254 sos_micro -- --ignored --nocapture`
...
#[test]
#[ignore = "manual field-op microbenchmark: cargo +1.97.1 test --release -p helius-bn254 sos_micro -- --ignored --nocapture"]
...
#[test]
#[ignore = "manual pairing-phase microbenchmark: cargo +1.97.1 test --release -p helius-bn254 sos_micro -- --ignored --nocapture"]
