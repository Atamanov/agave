/* @generated at build time by the helios-bn254 build script.
   Source of truth: crates/helios-bn254/build/schedule.rs (ADR 0001).
   Inspect a copy: HELIOS_DUMP_ASM=<absolute dir> cargo build.
   Verified by: tests/kernelgen_verify.rs (interpreter + determinism).

   helios_mont4_mul_x86: schedule bn254-mont4-mul-cios-dual-chain, 153 instructions, 763 bytes
   helios_mont4_sqr_x86: schedule bn254-mont4-sqr-cross-double, 150 instructions, 683 bytes
   helios_sos_x86: schedule bn254-sos-rolled-dual-chain, 128 instructions, 540 bytes
   helios_sosd2_small_x86: schedule bn254-sosd2-dual-lane-rolled, 193 instructions, 909 bytes
   helios_fp6_mul_x86: schedule bn254-fp6-mul-rolled-dual-lane-t6, 335 instructions, 1415 bytes
   helios_fp12_034_x86: schedule bn254-fp12-034-rolled-dual-lane-t6, 413 instructions, 1750 bytes
   helios_fp12_sqr_x86: schedule bn254-fp12-sqr-lazy-karatsuba-dblwidth, 700 instructions, 3071 bytes, 2072 rodata bytes
   helios_fp12_mul_x86: schedule bn254-fp12-mul-lazy-karatsuba-dblwidth, 650 instructions, 2860 bytes, 2256 rodata bytes
   helios_cyc_sqr_x86: schedule bn254-cyc-sqr-lazy-fp4-dblwidth, 479 instructions, 2098 bytes, 2928 rodata bytes
   helios_sosd6_x86: schedule bn254-sosd6-dual-lane-rolled-t6, 263 instructions, 1287 bytes
...
/* helios_mont4_mul_x86 register map:
...
*/
    .p2align 4
    .globl helios_mont4_mul_x86
    .type helios_mont4_mul_x86, @function
helios_mont4_mul_x86:
    push rbx
    push rbp
    push r12
    push r13
    ...
    pop rbx
    ret
    .size helios_mont4_mul_x86, . - helios_mont4_mul_x86

/* helios_mont4_sqr_x86 register map:
   rdi  z: result pointer (argument 1, live throughout)
...
*/
    .p2align 4
    .globl helios_mont4_sqr_x86
    .type helios_mont4_sqr_x86, @function
helios_mont4_sqr_x86:
    push rbx
    push rbp
    push r12
    push r13
    ...
    pop rbx
    ret
    .size helios_mont4_sqr_x86, . - helios_mont4_sqr_x86

/* helios_sos_x86 register map:
...
*/
    .p2align 4
    .globl helios_sos_x86
    .type helios_sos_x86, @function
helios_sos_x86:
    push rbx
    push rbp
    push r12
...
.Lsos_pair:
    ...
    pop rbx
    ret
    .size helios_sos_x86, . - helios_sos_x86

/* helios_sosd2_small_x86 register map:
...
*/
    .p2align 4
    .globl helios_sosd2_small_x86
    .type helios_sosd2_small_x86, @function
helios_sosd2_small_x86:
    push rbx
    push rbp
    push r12
    push r13
...
.Lsosd2_round:
    ...
    pop rbx
    ret
    .size helios_sosd2_small_x86, . - helios_sosd2_small_x86

/* helios_fp6_mul_x86 register map:
...
*/
    .p2align 4
    .globl helios_fp6_mul_x86
    .type helios_fp6_mul_x86, @function
helios_fp6_mul_x86:
    push rbx
    push rbp
    push r12
...
.Lfp6_prod:
    ...
    pop rbx
    ret
    .size helios_fp6_mul_x86, . - helios_fp6_mul_x86

/* helios_fp12_034_x86 register map:
...
*/
    .p2align 4
    .globl helios_fp12_034_x86
    .type helios_fp12_034_x86, @function
helios_fp12_034_x86:
    push rbx
    push rbp
    push r12
...
.Lf034_out:
    ...
    pop rbx
    ret
    .size helios_fp12_034_x86, . - helios_fp12_034_x86

/* helios_fp12_sqr_x86 register map:
...
*/
    .p2align 4
    .globl helios_fp12_sqr_x86
    .type helios_fp12_sqr_x86, @function
helios_fp12_sqr_x86:
    push rbx
    push rbp
    push r12
...
.Lfsq_out:
    ...
    pop rbx
    ret
    .size helios_fp12_sqr_x86, . - helios_fp12_sqr_x86

/* helios_fp12_mul_x86 register map:
   rdi  z on entry (spilled); walk destination pointer in every table-driven pass
...
*/
    .p2align 4
    .globl helios_fp12_mul_x86
    .type helios_fp12_mul_x86, @function
helios_fp12_mul_x86:
    push rbx
    push rbp
    push r12
...
.Lfmu_out:
    ...
    pop rbx
    ret
    .size helios_fp12_mul_x86, . - helios_fp12_mul_x86

/* helios_cyc_sqr_x86 register map:
   rdi  z on entry (spilled); walk destination pointer in every table-driven pass
   rsi  f pointer on entry (staging source); walk source-1 pointer; mask scratch
   rdx  consts pointer on entry; the implicit mulx multiplicand; walk scratch
...
*/
    .p2align 4
    .globl helios_cyc_sqr_x86
    .type helios_cyc_sqr_x86, @function
helios_cyc_sqr_x86:
    push rbx
    push rbp
    push r12
...
.Lcyc_out:
    ...
    pop rbx
    ret
    .size helios_cyc_sqr_x86, . - helios_cyc_sqr_x86

/* helios_sosd6_x86 register map:
...
*/
    .p2align 4
    .globl helios_sosd6_x86
    .type helios_sosd6_x86, @function
helios_sosd6_x86:
    push rbx
    push rbp
    push r12
...
.Lsosd6_pair:
    ...
    pop rbx
    ret
    .size helios_sosd6_x86, . - helios_sosd6_x86
