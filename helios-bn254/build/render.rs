...
pub const MUL_SYMBOL: &str = "helios_mont4_mul_x86";
pub const SQR_SYMBOL: &str = "helios_mont4_sqr_x86";
pub const SOS_SYMBOL: &str = "helios_sos_x86";
pub const SOSD2_SMALL_SYMBOL: &str = "helios_sosd2_small_x86";
pub const FP6_SYMBOL: &str = "helios_fp6_mul_x86";
pub const FP12_034_SYMBOL: &str = "helios_fp12_034_x86";
pub const FP12_SQR_SYMBOL: &str = "helios_fp12_sqr_x86";
pub const FP12_MUL_SYMBOL: &str = "helios_fp12_mul_x86";
pub const CYC_SQR_SYMBOL: &str = "helios_cyc_sqr_x86";
pub const SOSD6_SYMBOL: &str = "helios_sosd6_x86";
...
pub fn render_mont4_x86_64() -> String {
    ...
    line("/* @generated at build time by the helios-bn254 build script.");
    line("   Source of truth: crates/helios-bn254/build/schedule.rs (ADR 0001).");
    line("   Inspect a copy: HELIOS_DUMP_ASM=<absolute dir> cargo build.");
