...
//!
//! This module exists only when `build.rs` emitted `helios_avx512_ifma`,
//! i.e. the target has `avx512f` and `avx512ifma` in its compile-time
//! features (force/deny via `HELIOS_AVX512_IFMA`).  As with the ADX tier
...
// SAFETY of every intrinsic call in this module: `helios_avx512_ifma` is
