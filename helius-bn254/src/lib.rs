...
pub use batch::{
    ...
    alt_bn128_pairing_map, encode_final_exponentiation_result, fr_batch_invert, fr_lincomb,
    g1_msm, g2_prepare, pairing_check_prepared, pairing_check_prepared_vs_target, pairing_map,
