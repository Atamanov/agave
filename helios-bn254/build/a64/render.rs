...
/// Apple Mach-O symbol (underscore-prefixed at the assembly level; the Rust
/// FFI declaration in `src/fp/aarch64.rs` names it `helios_mont4`).
pub const MONT4_SYMBOL: &str = "_helios_mont4";
...
pub fn render_mont4_aarch64() -> String {
    ...
    line("   Source of truth: crates/helios-bn254/build/a64/schedule.rs (ADR 0001).");
